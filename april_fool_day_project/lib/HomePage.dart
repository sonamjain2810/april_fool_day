import 'dart:async';
import 'dart:io';
import 'package:april_fool_day/data/Messages.dart';
...
import 'package:april_fool_day/StatusList.dart';
import 'package:april_fool_day/widgets/CustomFBTextWidget.dart';
import 'package:april_fool_day/widgets/CustomFeatureCard.dart';
import 'package:april_fool_day/widgets/CustomFullCard.dart';
...
// Native Ad Open
  ...
  Strings.androidAdmobNativeId: Strings.iosAdmobNativeId;
...
//Native Ad Close
  ...
  static const MobileAdTargetingInfo targetingInfo = MobileAdTargetingInfo(
    testDevices: Strings.testDevice != null ? <String>[Strings.testDevice] : null,
  ...
  InterstitialAd createInterstitialAd() {
    return InterstitialAd(
      ...
      Strings.androidAdmobInterstitialId: Strings.iosAdmobInterstitialId,
      targetingInfo: targetingInfo,
      listener: (MobileAdEvent event) {
        print(
             "InterstitialAdId " + _interstitialAd.adUnitId
          );
        ...
        } else if (event == MobileAdEvent.opened || event == MobileAdEvent.failedToLoad) {
          _isInterstitialAdReady = false;
          if (interstitialTag != null) {
            switch (interstitialTag) {
              case "message":
  ...
  void initState() {
    ...
    FirebaseAdMob.instance.initialize(
      appId: Platform.isAndroid ? Strings.androidAdmobAppId : Strings.iosAdmobAppId
      );
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("April Fool Status Wishes",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("April Fool Day Images",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  CustomFeatureCard(
                                      size: size,
                                      imageUrl:
                                          Images.images_path[4],
                                      ontap: null),
                                  CustomFeatureCard(
                                      size: size,
                                      imageUrl:
                                          Images.images_path[3],
                                      ontap: null),
                                ],
                              ),
                              onTap: () {
                  ...
                  DesignerContainer(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                          child: Text("Generate April Fool Memes",
                              style: Theme.of(context).textTheme.headline1),
                        ),
                        Padding(
                          padding: EdgeInsets.all(SizeConfig.width(8)),
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  AppStoreAppsItemWidget1(
                                      ...
                                      appUrl:
                                          "https://apps.apple.com/us/app/happy-thankyou_messages-greeting-sms/id1435157874"),
                                  Divider(),
                                  AppStoreAppsItemWidget1(
                                      imageUrl:
